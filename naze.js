...
const nyoutube = ('©MossC\nInstagram\n@mo.sesc')  //ubah di config biar ngk emror
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendText(m.chat, `Tidak Usah Donasi Adick Adick Uang Nya Di Tabung Ajah. Terima Kasih Buat Niat Baiknya`)
            }
            break
            case 'sc': {
                m.reply('https://wa.me/6282141850862')
            }
            break		 
            case 'chat': {
...
╰──❍`
                ...
                {title: "Soon", rowId: `mislamic`, description: `Soon`},
